...
execute if entity @s[scores={TimeL=1..,Track=1}] run data merge block 995 36 1007 {Text2: '{"selector":"@a[tag=Highscore,limit=1]","color":"blue"}', Text3: '{"text":"","color":"blue","extra":[{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"SecondsL"}},{"text":"."},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1,scores={Centiemes=..9}]","objective":"global"}},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"CentiemesL"}},{"text":"s"}]}'}
execute if entity @s[scores={TimeL=1..,Track=2}] run data merge block 974 35 1012 {Text2: '{"selector":"@a[tag=Highscore,limit=1]","color":"blue"}', Text3: '{"text":"","color":"blue","extra":[{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"SecondsL"}},{"text":"."},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1,scores={CentiemesL=..9}]","objective":"global"}},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"CentiemesL"}},{"text":"s"}]}'}
execute if entity @s[scores={TimeL=1..,Track=3}] run data merge block 978 40 1044 {Text2: '{"selector":"@a[tag=Highscore,limit=1]","color":"blue"}', Text3: '{"text":"","color":"blue","extra":[{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"SecondsL"}},{"text":"."},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1,scores={CentiemesL=..9}]","objective":"global"}},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"CentiemesL"}},{"text":"s"}]}'}
execute if entity @s[scores={TimeL=1..,Track=4}] run data merge block 998 42 1051 {Text2: '{"selector":"@a[tag=Highscore,limit=1]","color":"blue"}', Text3: '{"text":"","color":"blue","extra":[{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"SecondsL"}},{"text":"."},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1,scores={CentiemesL=..9}]","objective":"global"}},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"CentiemesL"}},{"text":"s"}]}'}
execute if entity @s[scores={TimeL=1..,Track=5}] run data merge block 1019 41 1034 {Text2: '{"selector":"@a[tag=Highscore,limit=1]","color":"blue"}', Text3: '{"text":"","color":"blue","extra":[{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"SecondsL"}},{"text":"."},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1,scores={CentiemesL=..9}]","objective":"global"}},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"CentiemesL"}},{"text":"s"}]}'}
execute if entity @s[scores={TimeL=1..,Track=6}] run data merge block 996 40 995 {Text2: '{"selector":"@a[tag=Highscore,limit=1]","color":"blue"}', Text3: '{"text":"","color":"blue","extra":[{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"SecondsL"}},{"text":"."},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1,scores={CentiemesL=..9}]","objective":"global"}},{"color":"aqua","bold":true,"score":{"name":"@a[tag=Highscore,limit=1]","objective":"CentiemesL"}},{"text":"s"}]}'}
