execute as @e[tag=GbBRrx,limit=1,sort=nearest] at @s run fill ~ ~3 ~-5 ~ ~3 ~5 spruce_fence
execute as @e[tag=GbBRry,limit=1,sort=nearest] at @s run fill ~-5 ~3 ~ ~5 ~3 ~ spruce_fence
